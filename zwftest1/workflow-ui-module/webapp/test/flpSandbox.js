		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ztestworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ztestworkflowuimodule-display": {
								"semanticObject": "ztestworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ztest.workflowuimodule",
									"url": sap.ui.require.toUrl("ztest/workflowuimodule")
								}
							}
						}
					}
