		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#xinworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"xinworkflowuimodule-display": {
								"semanticObject": "xinworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=xin.workflowuimodule",
									"url": sap.ui.require.toUrl("xin/workflowuimodule")
								}
							}
						}
					}
